...
class BlogpostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blogpost" do
    assert_difference("Blogpost.count") do
      post blogposts_url, params: { blogpost: { description: @blogpost.description, title: @blogpost.title } }
    end
  ...
  test "should update blogpost" do
    patch blogpost_url(@blogpost), params: { blogpost: { description: @blogpost.description, title: @blogpost.title } }
